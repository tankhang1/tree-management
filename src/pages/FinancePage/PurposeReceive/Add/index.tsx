      ...
      <Stepper active={activeStep} onStepClick={setActiveStep}>
        ...
        <Stepper.Step label="Bước 1" description="Thông tin định danh">
          <Card shadow="sm" padding="lg" radius={4}>
            <Stack gap="md">
              <Input.Wrapper label="Đối tượng thu">
                <Group gap="md">
                  <Button
                    variant="filled"
              ...
              <TextInput radius={4} label="Người thu" placeholder="Người thu" />
              ...
              />
              <SelectableEnterpriseCards isCheckbox={false} isMulti={false} />
              <TextInput radius={4} label="Người nộp" placeholder="Người nộp" />
              <ContactListCards isTouchable={true} />
              <MultiSelect
                radius={4}
                label="Mục đích"
                ...
                <Card shadow="xs" padding="md" radius={4} withBorder>
                  ...
                  <Group gap="sm" align="flex-start">
                    <Stack flex={1} gap={"xs"}>
                      ...
                      <Group align="center">
                        <Title order={4}>Tổng tiền thu</Title>
...
export default FinancePurposeReceiveAddPage;
