...
const cultivationNoteData: CultivationNote[] = [
  {
    id: "CN-PH001",
    expectedStart: "2025-03-01",
    expectedEnd: "2025-03-03",
    actualStart: "2025-03-02",
    actualEnd: "2025-03-03",
  },
  {
    id: "CRN-PH002",
    expectedStart: "2025-02-15",
    expectedEnd: "2025-02-17",
    actualStart: "2025-02-16",
    actualEnd: "2025-02-17",
  },
];
...
const treeDetail: TreeDetail = {
  ...
  name: "Đậu nành DT84",
  type: "Cây ngắn ngày",
  note: "Ưa đất tơi xốp, thoát nước; pH 5.5–6.5.",
  seedCode: "DN-DT84",
  ...
  germinationRate: "90",
  yield: "2.5",
  seedNote: "Gieo mật độ 35–40 cây/m², bón lót hữu cơ.",
  seedDoc: null,
  harvestMethod: "Theo lứa (gặt/thu hạt)",
  growthCycle: "85–110 ngày",
  growthStages: ["Nảy mầm", "Sinh trưởng", "Ra hoa", "Tạo hạt", "Chín"],
  growthTime: "100",
  growthNote: "Theo dõi ẩm độ đất, phòng rỉ sắt và sâu cuốn lá.",
};
...
const PLOTS = [
  {
    ...
    crops: [
      {
        cropGroup: "Cây ngắn ngày",
        cropCode: "SOY001",
        cropName: "Đậu nành",
        cultivar: "DT84",
        seedCode: "HatSOY-A1",
        seedName: "Hạt giống DT84",
        image:
      ...
      },
      {
        ...
        cultivar: "LVN10",
        seedCode: "HatCORN-A1",
        seedName: "Hạt giống LVN10",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/1/17/Corncobs.jpg",
      },
      {
        cropGroup: "Cây ngắn ngày",
        cropCode: "CORN002",
    ...
    crops: [
      {
        ...
        seedName: "Hạt giống DT84",
        image:
          "https://upload.wikimedia.org/wikipedia/commons/2/23/Soybean.USDA.jpg",
      },
    ],
  },
