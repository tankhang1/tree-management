...
import { seedOptions } from "../../Row/Add";
...
const regionOptions: RegionOption[] = [
  ...
  {
    code: "VT-005",
    name: "Vùng Trồng Đồng Bằng Sông Hồng",
    area: "70.000 m²",
    soilType: "Đất phù sa màu mỡ",
    terrain: ["Bằng phẳng"],
  },
  {
    code: "VT-006",
  ...
  {
    code: "VT-008",
    name: "Vùng Trồng Cao Bằng - Lạng Sơn",
    area: "40.000 m²",
    soilType: "Đất feralit trên đá vôi",
    terrain: ["Đồi núi thấp", "Dốc"],
  },
  {
    code: "VT-009",
    name: "Vùng Trồng Hà Giang",
    area: "35.000 m²",
    soilType: "Đất đá vôi",
    terrain: ["Đồi núi cao", "Dốc đứng"],
  },
  {
    code: "VT-010",
    name: "Vùng Trồng Bình Thuận",
    area: "75.000 m²",
    soilType: "Đất cát pha",
    terrain: ["Bằng phẳng", "Thoai thoải"],
  },
  {
    code: "VT-011",
    name: "Vùng Trồng Nghệ An",
    area: "50.000 m²",
    soilType: "Đất đỏ vàng",
    terrain: ["Đồi núi thấp", "Thoai thoải"],
  },
  {
    code: "VT-012",
    name: "Vùng Trồng Quảng Nam",
    area: "65.000 m²",
    soilType: "Đất phù sa ven sông",
    terrain: ["Bằng phẳng", "Thoai thoải"],
  },
  {
    code: "VT-013",
    name: "Vùng Trồng Phú Yên",
    area: "55.000 m²",
    soilType: "Đất xám bạc màu",
    terrain: ["Bằng phẳng", "Thoai thoải"],
  },
  ...
  {
    code: "VT-015",
    name: "Vùng Trồng Cà Mau",
    area: "60.000 m²",
    soilType: "Đất than bùn",
    terrain: ["Thấp", "Trũng"],
  },
];
    ...
    initialValues: {
      ...
      plots: [
        ...
        },
        {
          ...
          name: "Lô C5",
          employee: "Phạm Thị D",
          cultivationMethod: "Canh tác thông minh",
          crops: [],
        },
      ],
    },
      ...
      <form onSubmit={form.onSubmit(handleSubmit)}>
        {active === 0 && (
          <Stack mt="md">
            ...
            <Stack gap={"xs"}>
              <Text fw={500} fz={15}>
                Danh sách lô theo khu vực đã chọn
              </Text>
              <Card withBorder>
                <Stack>
