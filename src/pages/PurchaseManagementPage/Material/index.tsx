...
const PurchaseManagementMaterialPage = () => {
  ...
  const onAddMaterial = () => {
    navigate(PATH.PURCHASE_MANAGEMENT_RAW_MATERIAL_ADD);
    ...
    <Stack gap="lg">
      <Group justify="space-between">
        ...
        <Group>
          ...
          <Button radius={4} onClick={onAddMaterial}>
            Thêm mới
          </Button>
        </Group>
      </Group>
...
export default PurchaseManagementMaterialPage;
