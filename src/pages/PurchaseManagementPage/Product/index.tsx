...
const PurchaseManagementProductPage = () => {
  ...
  const onAddProduct = () => {
    navigate(PATH.PURCHASE_MANAGEMENT_PRODUCT_ADD);
    ...
    <Stack gap="lg">
      <Group justify="space-between">
        ...
        <Group>
          ...
          <Button radius={4} onClick={onAddProduct}>
            Thêm mới
          </Button>
        </Group>
      </Group>
...
export default PurchaseManagementProductPage;
