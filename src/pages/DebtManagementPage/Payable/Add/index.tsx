...
const DebtManagementPayableAddPage = () => {
  ...
  return (
    <Card withBorder shadow="sm" p="lg" radius={4}>
      <Group mb={"xs"}>
        ...
        <Title order={3}>Thêm mới phiếu công nợ phải trả</Title>
      </Group>
      <Stack gap="lg">
            ...
            <Stack gap="xs">
              <Input.Wrapper label="Phân loại">
                <Group gap="md">
                  ...
                  <Button
                    variant={selectedCategory === "bank" ? "filled" : "outline"}
          ...
          <Stepper.Completed>
            <Stack align="center" justify="center" mt="xl">
              ...
              <Text fz={"h2"} ta="center">
                Thêm mới công nợ phải trả thành công!
              </Text>
...
export default DebtManagementPayableAddPage;
