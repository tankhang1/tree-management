...
const PlanManagementAssignDetailPage = () => {
  ...
  const data = {
    ...
    crop: "Đậu nành",
    cropCode: "DAU-001",
    cropVariety: "Đậu nành DT84",
    cropSeed: "DN-DT84-2025",
    cropImage:
    ...
    cropDescription:
      "Giống đậu nành DT84 sinh trưởng khoẻ, thích hợp đất tơi xốp pH 5.5–6.5, thời gian sinh trưởng khoảng 95–110 ngày.",
    harvestUnit: "tấn/ha",
    duration: 100,
        ...
        stages: [
          {
            ...
            document: "Quy-trinh-nay-mam-dau-nanh.pdf",
            materials: ["Phân NPK"],
            equipment: ["Bình tưới"],
            pesticides: [],
            leader: "Nguyễn Văn A",
          ...
          },
          {
            ...
            document:
              "Theo dõi ẩm độ đất, làm cỏ sớm; có thể bón thúc NPK và phun vi lượng nếu lá nhạt màu.",
            materials: ["Vôi bột"],
            equipment: ["Máy xịt"],
            pesticides: ["Confidor"],
            leader: "Trần Thị B",
