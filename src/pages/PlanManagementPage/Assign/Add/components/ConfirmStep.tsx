...
const ConfirmStep = () => {
  const data = {
    ...
    cropDescription:
      "Đậu nành sinh trưởng 85–110 ngày, ưa đất tơi xốp pH 5.5–6.5; cần ẩm đều, tránh úng giai đoạn nảy mầm và ra hoa.",
    harvestUnit: "kg",
    duration: 95,
        ...
        stages: [
          {
            ...
            document: "Tài liệu gieo hạt đậu nành.pdf",
            materials: ["NPK 16-16-8"],
            equipment: ["Bình tưới"],
            pesticides: ["Thiram xử lý hạt"],
            leader: "Nguyễn Văn A",
          ...
          },
          {
            ...
            document:
              "Giữ ẩm 65–75%, làm cỏ sớm; bón thúc đạm nhẹ 1–2 lần, theo dõi sâu cuốn lá.",
            materials: ["Ure/Đạm bổ sung"],
            equipment: ["Máy xịt"],
            pesticides: ["Emamectin 5%"],
            leader: "Trần Thị B",
            members: ["Lê Văn C"],
            resources: [
              {
